...
from  CVF_model.model_attn_aff_voc_seg import  CVF
import imageio as imageio
parser = argparse.ArgumentParser()
# parser.add_argument("--config",default='configs/coco_attn_reg.yaml',type=str, help="config")
...
def validate(model, dataset, test_scales=None):
    ...
    for idx, data in tqdm(enumerate(data_loader), total=len(data_loader), ncols=100, ascii=" >="):
        ...
        refine_cams = model(inputs.cuda(), cam_only=True).detach()
