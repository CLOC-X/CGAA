...
if __name__ == "__main__":
    ...
    parser.add_argument('--img_root', type=str, default='xxx/train2014')
    parser.add_argument('--split_file', type=str, default='/train.txt')
    parser.add_argument('--cam_out_dir', type=str, default='./coco_test')
    parser.add_argument('--model', type=str, default='/clip/ViT-B-16.pt')
