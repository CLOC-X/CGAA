...
from CVF_model.model_attn_aff_coco import CVF
...
def validate(model=None, data_loader=None, cfg=None):
    ...
    model.train()
    tab_results = format_tabs([cam_score, seg_score], name_list=["CAM",  "Seg_Pred"], cat_list=coco.class_list)
...
def train(cfg):
    ...
    for n_iter in range(cfg.train.max_iters):
        ...
        avg_meter.add({'seg_loss': seg_loss.item(), 'attn_loss': attn_loss.item(),'pat_loss': pat_loss.item(), 'seg_loss_1': seg_loss_1.item()})
